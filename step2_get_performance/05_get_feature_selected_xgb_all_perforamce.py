...
cv_bin_classifiy_performance_with_std(X=X_sel, y=y, splits_num=5, classfiers=get_all_classfiers(), random_seed=4, outputName='all_performance_feature_selected_by_XGB_')
